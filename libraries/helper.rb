  ...
  module Helper
    ...
    def self.sql_server_url(version, x86_64)
      if x86_64
        ...
        when '2019' then 'https://download.microsoft.com/download/8/4/c/84c6c430-e0f5-476d-bf43-eaaa222a72e0/SQLEXPR_x64_ENU.exe'
        end
      else
        case version.to_s
    ...
    def self.sql_server_checksum(version, x86_64)
      if x86_64
        ...
        when '2019' then '702D304852293F76D563C8DB09680856D85E537B08EB1401B3E283BA7847607B'
        end
      else
        case version.to_s
